...
Instrument: `mcp__ms365__graph-batch` against `user@example.com` (**consumer OneDrive, `driveType: personal`**, drive `0123456789ABCDEF`). Read-only GETs. The work/school account on this machine (`user@contoso.com`) is logged out, so **nothing here is measured on SharePoint or OneDrive for Business** — that is the single biggest gap in this report.
...
| 3a | `/me/drive/items/0123456789ABCDEF!219/delta?$top=3` | **200 — the undocumented folder-scoped form works and is genuinely scoped**: returns the folder plus descendants whose `parentReference.path` is `/drive/root:/Email attachments` |
...
```json
{
  "eTag": "\"{89ABCDEF-4567-2123-8001-A70000000000},2\"",
  "id": "0123456789ABCDEF!167",
  "lastModifiedDateTime": "2011-06-23T05:29:20Z",
  "name": "Sample Resumé.docx",
  "cTag": "\"c:{89ABCDEF-4567-2123-8001-A70000000000},2\"",
  "size": 27452,
  "parentReference": {
    "driveType": "personal", "driveId": "0123456789ABCDEF",
    "id": "0123456789ABCDEF!s0123456789abcdef0123456789abcdef",
    "path": "/drive/root:",
    "siteId": "5a6b7c8d-1e2f-4a3b-9c4d-5e6f7a8b9c0d"
  },
  "file": {
    "mimeType": "application/vnd.openxmlformats-officedocument.wordprocessingml.document",
    "hashes": {
      "quickXorHash": "EXAMPLEqXorHashValue0000001=",
