...
| PyMuPDF4LLM 1.28.2 | 12-page real account-statement PDF | sha256 ×3 | **identical** [tested] |
...
12-page browser-printed account statement, same file, both converters:
...
`/tmp/scratchpad/conv/` (venv at `./v`, fixtures `fix.{docx,xlsx,pptx,pdf}`,
